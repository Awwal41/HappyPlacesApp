package bgtap.babbangona.happyplacesapp.activities
...
import bgtap.babbangona.happyplacesapp.database.DatabaseHandler
import bgtap.babbangona.happyplacesapp.models.HappyPlaceModel
import bgtap.babbangona.happyplacesapp.utils.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(bgtap.babbangona.happyplacesapp.R.layout.activity_add_happy_place)
        ...
        if (!Places.isInitialized()) {
            Places.initialize(
                ...
                resources.getString(bgtap.babbangona.happyplacesapp.R.string.google_maps_api_key)
            )
        }
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            bgtap.babbangona.happyplacesapp.R.id.et_date -> {
                DatePickerDialog(
                    this@AddHappyPlaceActivity,
            ...
            bgtap.babbangona.happyplacesapp.R.id.tv_add_image -> {
            ...
            bgtap.babbangona.happyplacesapp.R.id.et_location -> {
                try {
            ...
            bgtap.babbangona.happyplacesapp.R.id.tv_select_current_location -> {
            ...
            bgtap.babbangona.happyplacesapp.R.id.btn_save -> {
